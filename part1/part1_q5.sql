...
((SELECT dog_id FROM Dogs WHERE name = 'Daisy'), '2025-06-12 11:00:00', 35, 'Hillside Trail', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'Milo'), '2025-06-12 13:00:00', 40, 'Riverbank Walk', 'completed');