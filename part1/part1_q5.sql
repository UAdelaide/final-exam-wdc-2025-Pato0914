...
((SELECT dog_id FROM Dogs WHERE name = 'Rocky'), '2025-06-10 08:00:00', 60, 'City Park', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Daisy'), '2025-06-10 08:00:00', 35, 'Hillside Trail', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'Milo'), '2025-06-10 08:00:00', 40, 'Riverbank Walk', 'completed'),